    ...
    <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${
      ...
      <nav className="container mx-auto px-6 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8 animate-fade-in-up">
          <a href="#heritage" className="text-white hover:text-rum-gold transition-colors duration-300 font-medium relative group">
            Heritage
            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-rum-gold transition-all duration-300 group-hover:w-full"></span>
          </a>
          <a href="#collection" className="text-white hover:text-rum-gold transition-colors duration-300 font-medium relative group">
            Collection
            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-rum-gold transition-all duration-300 group-hover:w-full"></span>
          </a>
          <a href="#craft" className="text-white hover:text-rum-gold transition-colors duration-300 font-medium relative group">
            Craft
            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-rum-gold transition-all duration-300 group-hover:w-full"></span>
          </a>
          <a href="#contact" className="text-white hover:text-rum-gold transition-colors duration-300 font-medium relative group">
            Contact
            <span className="absolute -bottom-1 left-0 w-0 h-0.5 bg-rum-gold transition-all duration-300 group-hover:w-full"></span>
          </a>
        </div>
